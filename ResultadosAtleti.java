...
public class ResultadosAtleti {
    ...
    public static double mediaGolesMarcados(Partido[] temporada) {
        ...
        double media = Arrays.stream(temporada).mapToInt(Partido::getGolesMarcados).average().getAsDouble();
        ...
        // }
        // double media = suma/temporada.length;
        return media;
    }
    ...
    public static int totalGolesMarcados(Partido[] temporada) {
        ...
        int golesMarcados = Arrays.stream(temporada).mapToInt(Partido::getGolesMarcados).sum();
        
        //FORMA DE CLASE
        // int golesMarcados = 0;
        // for (Partido partido : temporada) {
        //     golesMarcados += partido.getGolesMarcados();
        // }
    ...
    public static int totalGolesRecibidos(Partido[] temporada) {
        ...
        int golesRecibidos = Arrays.stream(temporada).mapToInt(Partido::getGolesRecibidos).sum();
        
        //FORMA DE CLASE
        // int golesRecibidos = 0;
        // for (Partido partido : temporada) {
        //     golesRecibidos += partido.getGolesRecibidos();
        // }
